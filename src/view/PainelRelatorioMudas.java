 ...
 * @author Walas Jhony
 */
public class PainelRelatorioMudas extends JPanel {
    ...
    public PainelRelatorioMudas(ActionListener al) {

        buttonGroup = new ButtonGroup();
        painelDados = new JPanel();
        painelPesquisas = new JPanel();
        radioButtonPesq1 = new JRadioButton("Datas do plantio de uma especie");
        radioButtonPesq2 = new JRadioButton("Mudas plantadas durante um perído de tempo");
        radioButtonPesq3 = new JRadioButton("Mudas plantadas por um socio");
        radioButtonPesq4 = new JRadioButton("Todas mudas plantadas até hoje");
    ...
    public String getTextNome(){
        String aux = ((JFormattedTextField)painelDados.getComponent(1)).getText();
        if(aux.equals(""))
            return null;
        else
            return aux;
